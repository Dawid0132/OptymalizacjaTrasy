package com.example.tsp_service.Config.RestTemplate;
...
public class RestTemplateResponsesError {
    ...
    public ResponseEntity<Void> handleConflict(HttpClientErrorException.Conflict e) {
        return ResponseEntity.status(HttpStatus.CONFLICT).build();
    }

    @ExceptionHandler(HttpClientErrorException.Unauthorized.class)
    public ResponseEntity<Void> handleNotAcceptable(HttpClientErrorException.Unauthorized e) {
